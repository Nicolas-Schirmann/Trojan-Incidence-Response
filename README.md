...
What's in this repo
`incident-report-doplik-chromeloader.md` — full write-up: detection timeline, infection chain diagram, investigation checklist, forensic execution analysis, findings, and sources
Methodology
